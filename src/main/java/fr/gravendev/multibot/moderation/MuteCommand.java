...
public class MuteCommand implements CommandExecutor {
    ...
    public void execute(Message message, String[] args) {
        ...
        if (mentionedMembers.size() == 0) {
            message.getChannel().sendMessage(Utils.buildEmbed(Color.RED, "Utilisation: mute @membre")).queue();
            return;
        }
        ...
        message.getChannel().sendMessage(Utils.muteEmbed(mutedUser, reason)).queue();
    }
